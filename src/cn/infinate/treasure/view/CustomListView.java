...
public class CustomListView extends ListView implements OnScrollListener {
	...
	private void addFooterView() {
		mEndRootView = mInflater.inflate(R.layout.listview_footer_more, null);
		...
		if (mCanLoadMore) {
			...
			case ENDINT_LOADING://刷新中
				...
				if(mEndLoadTipsTextView.getText().equals(
						R.string.refresh_doing_end_refresh)){
					break;
				}
				mEndLoadTipsTextView.setText(R.string.refresh_doing_end_refresh);
			...
			case ENDINT_MANUAL_LOAD_DONE:// 手动刷新完成
				...
				// 点击加载
				mEndLoadTipsTextView.setText(R.string.refresh_end_click_load_more);
				mEndLoadTipsTextView.setVisibility(View.VISIBLE);
			...
			case ENDINT_AUTO_LOAD_DONE:// 自动刷新完成
				...
				// 更    多
				mEndLoadTipsTextView.setText(R.string.refresh_end_load_more);
				mEndLoadTipsTextView.setVisibility(View.VISIBLE);
				mEndLoadProgressBar.setVisibility(View.GONE);
...
//				}
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_TO_REFRESH:
			...
			// 松开刷新
			mTipsTextView.setText(R.string.release_refresh);
		...
		case PULL_TO_REFRESH:
			...
			if (mIsBack) {
				...
				// 下拉刷新
				mTipsTextView.setText(R.string.pull_refresh);
			} else {
				// 下拉刷新
				mTipsTextView.setText(R.string.pull_refresh);
			}
		...
		case REFRESHING:
			...
			// 正在刷新...
			mTipsTextView.setText(R.string.refresh_doing_head_refresh);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);
	...
	public void onRefreshComplete() {
		...
		mLastUpdatedTextView.setText(
				getResources().getString(R.string.refresh_lasttime) + 
